...
bokeh_process = subprocess.Popen(["bokeh", "serve", "--allow-websocket-origin=testbokeh123.herokuapp", "--port=$PORT", "bokeh_plot.py"],stdout=subprocess.PIPE)
...
@app.route('/')
def index():
    session=pull_session(url='default')
