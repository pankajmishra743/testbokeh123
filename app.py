...
bokeh_process = subprocess.Popen(["bokeh", "serve", "--allow-websocket-origin=testbokeh123.herokuapp","--port=5000", "--host=testbokeh123.herokuapp.com", "--host=*", "--address=0.0.0.0", "--use-xheaders", "bokeh_plot.py"],stdout=subprocess.PIPE)
